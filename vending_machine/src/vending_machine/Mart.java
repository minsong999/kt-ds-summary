...
//	}
	...
	/**
	 * refactoring ==> 코드를 깔끔하게 개선하는 과정 1. 메소드 Body 라인 수 : 20라인 이하로 작성할 것 2. 클래스명,
	 * 메소드명, 변수(인스턴스)명은 명확하게 지을 것. 3. 메소드 구성은 신문기사처럼 쓸 것. -기사의 내용처럼, 편하게 읽을 수 있도록
	 * 만든다. - 메소드 Chain을 순서대로 작성. - 주문 -> 재고수 감소 -> 돈을 증가 -> 고객에게 재고를 증가시킨다. - 주문()
	 * - 재고수 감소() - 돈을 증가() - 고객에게 재고를 증가()
	 */
	...
	public static void main(String[] args) {
		...
		/*
		 * Object --> Product --> TemperatureProduct Product is a Object
		 * TemperatureProduct is a Product TemperatureProduct is a Object
		 */
...
//		System.out.println(p);
		...
		drinkMachine.addProduct("엔초",700,10);
